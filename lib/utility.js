...
exports.makeCookie = function(username, res, cb) {
  exports.createHash(username + passkey.userPasskey, function(hash) {
...
exports.checkUser = function(cookie, cb){
  ...
  exports.validateUser(userCookieInfo[0] + passkey.userPasskey, userCookieInfo[1], function(result) {
    cb(result);
  });
};
